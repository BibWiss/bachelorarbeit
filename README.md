[![DOI](https://zenodo.org/badge/222508234.svg)](https://zenodo.org/badge/latestdoi/222508234)
# bachelorarbeit &#128451;
...
2. [research_data](#2-research_data)
3. [scripts](#3-scripts)
...
The **research_data** folder contains the following attachements:
* E1 - Extraction of the followers / followees of the seed set ("Kernpersonen")
* E2 - summary of E2
* E3 - userdata of the representative set of accounts ("Repräsentative Accounts")
* E4 - follower of the persons (within the representative accounts)
* E5 - summary of E4

You can find more information on the research data and what role it played during the research process in chapter 3 of the bachelor thesis itself ("3. Methodik", page 16-28). 
